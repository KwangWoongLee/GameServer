...
class S_PlayerInfoReq : IPacket
{
    ...
    public ushort Protocol { get { return (ushort)PacketID.S_PlayerInfoReq; } }
    ...
    public ArraySegment<byte> Write()
    {
        ...
        count += sizeof(ushort);
        success &= BitConverter.TryWriteBytes(s.Slice(count, s.Length - count), (ushort)PacketID.S_PlayerInfoReq);
        count += sizeof(ushort);
